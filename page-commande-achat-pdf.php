       ...
       /* //GET Adresse de livraison
        ...
        if($lignesCount > 0) {
            ...
            $user = array(
                ...
                $Liv = array(
                    "id" => 1,
                    "livrPrev" => $commande['co_date_livraison_prevu'],
                    "livrReel" => $commande['co_date_livraison_reelle'],
                    "infos" => ""
                );
            ...
            foreach ($lignes as $value) {
                ...
                $tasks[] = array(
                    "id" => $i,
                    "description" => '<h5 style="margin-bottom: 0">'.$value['pi_libelle'].'</h5>'.'<small>Ref : '.$value['pi_ref'].'<br>Fournisseur : '.$value['pi_fournisseur'].'</small>',
                    "price" => $value['lc_mtn'],
        ...
        <page backtop="10mm" backleft="10mm" backright="10mm" backbottom="10mm" footer="page;">
          ...
          <table style="vertical-align: top;margin-top: 15px;">
              <tr>
                  ...
                  <td class="50p">
                      <strong>Livraison prévue : '.$Liv["livrPrev"].'</strong><br />
                      <strong>Livraison réelle : '.$Liv["livrReel"].'</strong><br />
                  </td>
              </tr>
          </table>
